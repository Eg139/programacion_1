...
# "El número es par y es múltiplo de 3" si el número es par y es múltiplo de 3, o "El número
# no cumple ninguna de las dos condiciones" si el número no cumple ninguna de las dos condiciones.
